...
<%
    ...
    request.setAttribute("getCat", categoryInst);
    //----------------------------------------------
    prod = p.categoryProduct(id);
    ...
    <center>
        <div class="lterNameinput">
            <form method="post" action="search">
                ...
                <button type="submit">Search</a></div>
            </form>
        </div>
    </center>
    <div class="lterName">
        <h1>${getCat.categoryName}</h1>
            ...
            <div class="fo-group1">
                ...
                <div class="fo-group2">
                    ...
                    <div class="group-data3">
                        ...
                        <p id="_role"style="color:blue; font-weight: bold; font-size: 20px"><% if (prod1.getDiscount() > 0) {%>Was R<%=dcf.format(prod1.getPrice())%><%} else {%>R<%=dcf.format(prod1.getPrice())%> <%}%></p>
