...
<%
    ...
    RecipeService recServ = new RecipeServiceImpl();
    Recipe rec = new Recipe();

    List<Recipe> recipes = recServ.getllRecipe();
...
<body>
    ...
    <div class="reg-Container">
        ...
        <br>
        <form method="post" action="AddRecipes?action=ingridient">



            <br>
                  <select name = "prodId" hidden>
            ...
            <label for="productDesc"><b> Ricipe# & Product Name </b></label>
            <br>              

            <select name = "recipeId" >
                <%  for (Recipe r : recipes) {%>
                <% Product pro = productData.viewOneProduct(r.getProductId());%>
                <option><%=r.getRecipeId() + "." + r.getRecipeDesc()%></option>
            ...
            <h>INVENTORY</h>
            <hr>
            <label for="max"><b>Max Stock </b></label>
            <input type="text" name="max"placeholder ="Max Stock">

            <label for="min"><b>Min Stock </b></label>
            <input type="text" name="max"placeholder ="Min Stock">
