...
<html>
    ...
    <div class="lterName">
        ...
        <center>
            <span  style="color: red" font-size="3px" >${error2}</span>
        </center>
            ...
            <div class="fo-group1">
                ...
                <div class="fo-group2">
                    ...
                    <div class="group-data3">
                        ...
                        <p id="_role"style="color:blue; font-weight: bold; font-size: 20px">Was R<%=dcf.format(prod1.getPrice())%></p>
                        <del> <p id="_role"style="color:red;font-weight: bold; font-size: 20px">Now R<%=dcf.format(disPrice)%></p></del>
                        <%} else {

                        %>
                        <p id="_role"style="color:blue; font-weight: bold; font-size: 20px">R<%=dcf.format(prod1.getPrice())%></p>
                        <%}%>
